...
public class RateThisApp {
	 ...
	 */
	public static final int LAUNCH_TIMES = 20;
	...
	public static void showRateDialog(final Context context) {
		...
		builder.setTitle(string.rate_this_app);
		builder.setMessage(string.rate_app_message);
		builder.setCancelable(false);
		builder.setPositiveButton(string.rate_this_app, new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				final String appPackageName = context.getPackageName(); // getPackageName() from Context or Activity
				try {
		...
		builder.setNeutralButton(string.remind_me, new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				clearSharedPreferences(context);
			}
		});
		builder.setNegativeButton(string.do_not_remind_me, new OnClickListener() {
			@Override
			public void onClick(DialogInterface dialog, int which) {
				setOptOut(context, true);
			}
